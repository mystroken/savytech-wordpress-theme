		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-12">
				<div class="about-content">
					...
					<h2 class="main-title fw-bold">Notre équipe est pleine d'expérience et de connaissance</h2>
						...
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<button class="nav-link active" id="nav-who-tab" data-bs-toggle="tab"
									...
									aria-selected="true">Qui Nous Sommes</button>
								<button class="nav-link" id="nav-vision-tab" data-bs-toggle="tab"
									data-bs-target="#nav-vision" type="button" role="tab" aria-controls="nav-vision"
									aria-selected="false">Notre Vision</button>
								<button class="nav-link" id="nav-history-tab" data-bs-toggle="tab"
									...
									aria-selected="false">Notre Histoire</button>
							</div>
						</nav>
	...
	<div class="container bg-primary-gradient py-5">
		<div class="row">
			<div class="col-md-8 col-xl-6 text-center mx-auto">
				<p class="fw-bold text-muted mb-2">Nos Services</p>
				<h3 class="fw-bold">Nos meilleurs services</h3>
			</div>
		</div>
					...
					<div class="card">
						<div class="card-body px-4 py-5 px-md-5">
							...
							<p class="text-muted card-text mb-4">Erat netus est hendrerit, nullam et quis ad cras
								porttitor iaculis. Bibendum vulputate cras aenean.</p><button class="btn btn-primary"
				...
				<div class="col mb-4">
					<div class="card">
						<div class="card-body px-4 py-5 px-md-5">
							...
							<button class="btn btn-primary text-white" type="button">Learn more</button>
						</div>
					</div>
				</div>
			</div>
...
<!-- CTA: Start -->
<section id="call-action" class="call-action" data-scroll-section>
	<div class="container">
