	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-4">
				<div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
					<div class="d-flex align-items-center p-3">
						<div
							class="bs-icon-md bs-icon-circle bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md">
			...
			<div class="col-xl-8">
				<div class="row mb-5">
					<div class="col-md-8 col-xl-6 text-center mx-auto">
						<p class="fw-bold text-muted mb-2">Contacts</p>
						<h2 class="fw-bold">Comment nous joindre</h2>
					</div>
				</div>
