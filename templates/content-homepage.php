					...
					<div class="about-five-tab">
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<button class="nav-link active" id="nav-who-tab" data-bs-toggle="tab" data-bs-target="#nav-who" type="button" role="tab" aria-controls="nav-who" aria-selected="true">Qui Nous Sommes</button>
					...
					<div class="card">
						<div class="card-body px-4 py-5 px-md-5">
							...
							<p class="text-muted card-text mb-4">Erat netus est hendrerit, nullam et quis ad cras
								porttitor iaculis. Bibendum vulputate cras aenean.</p><button class="btn btn-primary" type="button">Learn more</button>
						</div>
					</div>
				</div>
				<div class="col mb-5">
					...
					<div class="card">
						<div class="card-body px-4 py-5 px-md-5">
							<div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon" style="top: 1rem;right: 1rem;position: absolute;">
								<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-quote">
			...
			<div class="col-xl-8">
				<div class="border rounded p-4">
					...
					<form class="" method="post">
						...
						<div><button class="btn btn-primary d-block w-100" type="submit">Envoyer le Message</button></div>
					</form>
				</div>
			</div>
		</div>
