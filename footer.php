...
<footer id="footer" class="footer bg-primary text-white" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
		...
		<div class="row">
			...
			<div class="col-lg-4 mb-5 mb-lg-0">
				<div>
					...
					<h4 class="text-secondary">+61 (0) 383 766 284</h4>
					<p> Level 13, 2 Elizabeth St,<br> Melbourne, Victoria 3000, Australia</p>
				</div>
			</div>
			<div class="col-lg-4">
